...
#include "../aocs/relative_attitude_sensor.hpp"
#include "../aocs/relative_position_sensor.hpp"
...
class RelativePositionAttitudeObserver : public Component, public ILoggable {
 public:
  ...
  RelativePositionAttitudeObserver(const int prescaler, ClockGenerator* clock_gen, std::vector<LaserDistanceMeter*>& laser_distance_meters,
                                   RelativePositionSensor& relative_position_sensor, RelativeAttitudeSensor& relative_attitude_sensor,
 ...
 protected:
  ...
  RelativeAttitudeSensor& relative_attitude_sensor_;
